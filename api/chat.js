...
IMPORTANT: Always respond in the SAME language the user used. If Arabic, reply in Arabic. If English, reply in English.
Always return ONLY valid JSON, nothing else. No markdown, no backticks.
